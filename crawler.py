...
def salvar_previsao(previsoes, filename):
...
if response.status_code == 200:
    ...
    previsao_directory = os.path.join(os.path.dirname(os.path.abspath(_file_)), 'previsoes')
    ...
    salvar_previsao(previsoes, filename)
